...
function ShowcaseCard({
  ...
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-3xl surface transition-all duration-control ease-soft hover:-translate-y-1 surface-hover">
      <div className="relative h-64 overflow-hidden border-b border-border bg-graphite">
      ...
      <div className="flex flex-1 flex-col p-7">
        <div className="flex items-center justify-between">
          ...
          <span className="inline-flex items-center gap-1 rounded-full surface px-2.5 py-0.5 text-[0.65rem] uppercase tracking-[0.14em] text-muted-foreground">
            {tag}
          </span>
        </div>
...
function ChatbotDemo() {
  ...
  return (
    <div ref={ref} className="relative flex h-full flex-col gap-2 p-4">
      <div className="mb-2 inline-flex items-center gap-2 self-start rounded-full border border-border bg-background/60 px-2.5 py-1 text-[0.65rem] text-muted-foreground backdrop-blur">
          ...
          <m.div
            ...
            className={
              msg.role === 'user'
                ...
                : 'self-start rounded-2xl rounded-bl-md bg-muted/60 px-3 py-1.5 text-xs text-foreground/90 ring-1 ring-border'
            }
          >
            {msg.text}
          </m.div>
      ...
      <div className="mt-2 flex items-center gap-2 rounded-full border border-border bg-background/60 px-3 py-1.5 backdrop-blur">
