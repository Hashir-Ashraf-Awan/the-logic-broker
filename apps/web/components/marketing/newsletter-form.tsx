...
export function NewsletterForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="relative">
      <div
        className={cn(
          'flex items-center rounded-full surface pl-4 pr-1 transition-all duration-control ease-soft focus-within:border-[hsl(var(--border-strong))] focus-within:bg-muted/40',
